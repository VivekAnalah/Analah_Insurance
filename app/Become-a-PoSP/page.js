    ...
    <div className="pb-4 st">
      <div className="container-fluid pb-4">
        <div className="flex flex-col sm:flex-row gap-[5%] mt-[50px] relative items-center ">
          <div className="flex flex-col sm:w-[50.6%] w-[80%]  ml-[4%]  order-2 sm:order-1 sm:[50%] sm:ml-[8.5%] sm:mt-[0px] mt-[15px]">
            <div className=" sm:space-y-[10%]  xl:pl-0  ">
              ...
              <div className="  lg:w-11/12 text-justify sm:mt-0 mt-[10px]">
                ...
                <h4 className="text-justify mb-[4%] text-[15px] md:text-[20px] font-normal  text-[#595959]">
                  We value your referrals and offer excellent commissions on all
                  our plans. So what are you waiting for? Join our team today,
                  sell insurance online as a PoSP and start earning passive
                  income!
                </h4>
          ...
          <div
            className=" flex flex-col order-1 sm:order-2 w-[70%] sm:w-[50%]"
            style={{
              background:
                "linear-gradient(171.81deg, #2A44A9 -68.4%, rgba(255, 255, 255, 0.06) 80.56%)",
              borderRadius: "280.5px 0px 0px 0px",
            }}
          >
      ...
      <div
        className="container-fluid w-12/12 pt-2 pb-20 pl-[10%] pr-[10%]"
        style={{ background: "#F7F8FC" }}
      >
        <div className="my-container flex space-y-5 flex-col items-center justify-center sm:mt-20 mt-10">
          <h2 className="font-semibold text-2xl lg:text-3xl text-[#000]">
            <span className="  sm:border-b-[5px] sm:pb-[15px] sm:border-[#2a44a9]">
              Why{" "}
            </span>
            become an Analah Insurance PoSP?{" "}
          </h2>
          <div className="my-8 flex space-y-5 flex-col  items-center justify-center text-justify ">
            <ul className="posp-content text-[#525252] mt-4 lg:mt-16 pb-6">
              <li>
                ...
                clientele and refer people to our insurance services and develop
                a steady stream of revenue through policy renewals. Additional
                work will increase your income further.
              </li>
              <li>
                <b>Ongoing Support & Regular Training:</b> When it comes to
                insurance, knowledge is key. Avail thorough and regular training
                from industry experts on latest products.
              </li>
              <li>
                <b>Work from anywhere at any time:</b> All PoSPs use online
                processes to sell policies, and hence are not required to travel
                anywhere to sell insurance. Being a PoSP agent gives you the
                flexibility to work from anywhere at any time, whether you wish
                to work full-time or part-time.
              </li>
              <li>
                <b> Designated Relationship Manager:</b> Joining our network of
                PoSPs ensures you are never alone during the sales process. A
                designated Relationship Manager is assigned to you, who helps
              ...
              <li>
                ...
                basis and will depend on the number of policies you sell and the
                renewals you receive. Set your own targets; the more policies
                you sell, the higher you can earn as a PoSP.
              </li>
              <li>
                <b>Awards and Recognition:</b> Gain national and international
                recognition by qualifying for global awards like Asia’s Trusted
                Life Insurance Agents and Advisors and more.
              </li>
              <li>
                <b>Monitor your Performance:</b> Our backend support & MIS helps
                you track your performance and records.
              </li>
            </ul>
