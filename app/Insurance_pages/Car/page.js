  ...
  const whyRequired_Text = [
    {
      ...
      require:
        "The Motor Vehicles Act of 1988 makes it mandatory for all vehicles, whether private or commercial, including electric vehicles, to have a valid third-party car insurance, wherein third-party liability is also mandatory. To comply with the law, the buyer must purchase or renew your Car Insurance.",
    },
    {
      id: 2,
      require_head: "Protection from Third-party Liabilities: ",
      require:
        "When your insured car causes damages to a third-party’s property or injuries to third-party, third-party liabilities are created. By covering your car with third-party insurance (also known as comprehensive insurance), you can protect against financial burdens brought on by third-party liabilities.",
    },
    {
      id: 3,
      require_head: "Coverage against Natural Calamities: ",
      require:
        "Natural calamities like floods, cyclones, earthquakes can cause significant damage to your car, and the cost of repairs may be very high. Comprehensive Car Insurance provides financial assistance for car repairs due to unexpected natural disasters.",
    },
    {
      id: 4,
      require_head: "Personal Accident Cover: ",
      require:
        "Insure your car and benefit from the Personal Accident Cover of up to INR 15 lakh. The policyholder (or owner-driver) receives compensation under this insurance in the event of bodily injury, death, or disability while operating the vehicle.",
    },
    {
      id: 5,
      require_head: "Protection from Car Theft: ",
      require:
        "Imagine that your insured vehicle is stolen and untraceable. Your Comprehensive Car Insurance Policy will compensate you for your financial loss.",
    },
    {
      id: 6,
      require_head: "Lowers Financial Burden: ",
      require:
        "Financial losses may result from a significant dent or scratch on your car brought on by an accident, natural disaster, or human error. Buying Comprehensive Car Insurance or Own Damage Cover protects you from these liabilities and keeps you protected against unanticipated financial losses. Certain Car Insurance policies also comes with the option of availing cashless services in the certified network garages across the nation.",
    },
  ];
  const add_ons_array = [
    {
      ...
      require:
        "No-claim Bonus (NCB) is a discount on the premium to be paid that the insurance company provides for every claim-free year. This bonus is cumulative and can increase every year. The NCB Protection cover protects the NCB. No Claim Bonus becomes void on making a claim and this add on the cover helps you in retaining the No Claim Bonus even after making a claim.",
    },
    {
      id: 2,
      require_head: "Engine Protection Cover : ",
      require:
        "The Engine Protection add-on provides coverage for any damage the engine sustains as a result of leaks or water intrusion. This add-on cover protects the engine, gearbox and certain other parts of the insured vehicle as per the terms and conditions of the policy.",
    },
    {
      id: 3,
      require_head: "Zero depriciation cover : ",
      require:
        "The Zero depreciation cover makes up for the car's depreciating value. The policyholder does not have to pay for the car's depreciated value if they have this coverage. This add-on is subject to certain claims. The feature of voluntary deductible remains applicable even with zero depreciation add-on cover.",
    },
    {
      id: 4,
      require_head: "Consumable Cover: ",
      require:
        "Consumable components, such as nuts, bolts, grease, lubricants, engine oil, brake oil, etc. are usually not covered during claim settlement. The Consumable Cover add-on, covers such costs while settling claims.",
    },
    {
      id: 5,
      require_head: "Key protection cover: ",
      require:
        "The Key Protection/Replacement cover, is an add-on that helps you cover the expenses incurred for key replacement or repair. The cover pays for replacement of the key and lock in case of thefts and loss.",
    },
    {
      id: 6,
      require_head: "Daily allowance: ",
      require:
        "In case the car is at the workshop for repairs for more than three days, this coverage offers the benefit of a daily allowance. This allowance is provided for travel by any means other than the insured vehicle.",
    },
    {
      id: 7,
      require_head: "Personal Accident Rider: ",
      require:
        "This add-on enables you to protect the passengers in case of any misfortune accidents that result in personal injury, death, disability or damage.",
    },
  ];
